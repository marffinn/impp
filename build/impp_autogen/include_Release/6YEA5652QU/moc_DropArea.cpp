...
void DropArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DropArea::*)(const QString & )>(_a, &DropArea::imageDropped, 0))
            return;
    }
}
...
// SIGNAL 0
void DropArea::imageDropped(const QString & _t1)
{
